...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xs-3 text-center">
                <button type="button" class="btn bg-gray pull-left search-btn" onclick="getlenderwallettrns();"><i
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="col-xs-3 text-center">
                            <select class="form-control choosenType" name="lenderSearch">
                                <option value="">-- Choose --</option>
                        ...
                        <div class="col-xs-3 text-center">
                            <button type="button" class="btn bg-gray pull-left search-btn"
                                onclick="getlenderwallettrns();"><i class="fa fa-angle-double-right"></i> <b>Status</b>
                            </button>
                        </div>
