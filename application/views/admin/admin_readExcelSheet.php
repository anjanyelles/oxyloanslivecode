...
<div class="content-wrapper">
 ...
 <div class="row col-12" >
                                     ...
                                     <div class="mb-1  col-md-6">
                                    <label for="bulkinviteUserType" class="form-label">User Type <em class="error">*</em> :</label></label>
                                    <select class="form-control" id="bulkinviteUserType" aria-describedby="helpId">
                                        <option value="">Choose Invite Type</option>
                                        <option value="Lender">Lender</option>
                                        <option value="Admin">Admin</option>
                                    </select>
                                    <small id="helpId" class="form-text error errorchoseUserInviteType" style="display:none">Choose User Type</small>
                                </div>


                                <div class="mb-1  col-md-6">
                                    <label for="useriviteId" class="form-label">User Id <em class="error">*</em> :</label></label>
                                    <input type="text" name="useriviteId" placeholder="Enter User Id" class="form-control" id=useriviteId>
                                    <small id="helpId" class="form-text error errorchoseUserId" style="display:none">Choose User Id</small>
                                </div>
