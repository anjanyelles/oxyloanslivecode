...
<div class="content-wrapper">
                        ...
                        <div class="tab-pane" id="profile">
                            ...
                            <div class="" style="width:100%;">
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <select class="form-control choosenType" id="cmsbeforefileSearch"
                                                onchange="cmsbeforefileSearchonchmage();">
                                                <option value="">-- Choose --</option>
                                        ...
                                        <div class="col-xs-2 text-center cmsbeforestartdatediv" style="display:none;">
                                            <input type="text" name="fdinvoicestartdate"
                                                class="form-control dashboardStart" placeholder="start Date">
                                        </div>

                                        <div class="col-xs-3 text-center cmsbeforeenddatediv" style="display:none;">
                                            <input type="text" name="invoiceenddate" class="form-control dashboardEnd"
                                        ...
                                        <div class="col-xs-1 text-center">
                                            <button type="button" class="btn bg-gray pull-left search-btn"
                                                onclick="cmsbeforefilesList()"><i class="fa fa-angle-double-right"></i>
                                                <b>Search</b>
                                            </button>
                                        </div>
                                    </div>
    ...
    <div class="modal modal-info fade" id="modal-confirm-generateFile11">
    ...
    <tr>
      <td>{{fileName}}</td>
           ...
           <td>{{fileStatus}}</td>
            <td>{{returnType}}</td>
             <td>   
            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-confirm-generateFile11" onclick="setFileName('{{fileName}}')">Delete</button>
        </td>
    </tr>
    {{/data}}
    </script>
    ...
    <div class="modal fade" id="modal-approve-withdrawfunds11" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success lenderwithdrawfundsBtn" data-clikedId="">ok </button>
                    &nbsp;&nbsp; &nbsp;&nbsp;
    ...
    <div class="modal fade" id="modal-approve-success" tabindex="-1" role="dialog"
        aria-labelledby="modal-interested-borrower" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-body">
    ...
    function setFileName(fileName) {
        // Set the fileName in the modal's button
        document.getElementById('modalButton').setAttribute('onclick', `generateh2hfilependingamount11('${fileName}')`);
        // document.getElementById('modalButton').textContent = fileName;
    }
    </script>
    <script>
    // Pass PHP data to JavaScript template rendering function
    var data = <?php echo json_encode($dataArray); ?>;
    var template = document.getElementById('partnerdisplayDealsCmsFolderList').innerHTML;
    var rendered = Mustache.render(template, {
        data: data
    });
    document.getElementById('yourTargetElementId').innerHTML = rendered;
    </script>
    <script>
    ...
    <script>
    // Define the JavaScript function that will be called
    function deletefileinBeforepath(fileName) {
        console.log("Deleting file:", fileName);
        // Add your logic to delete the file or make an AJAX request
    }
    </script>
