...
<div class="content-wrapper">
    ...
    <td><b>Regd Date</b>:- {{loanRequestedDate}}<br/>
            ...
            <br/><br/>
            <b>DOB :</b>{{lenderUser.dob}}<br/>
            <b>Actual  DOB :</b>: {{lenderUser.originalDob}}
        </td>
...
<td class="user-ViewDocs{{lenderUser.id}}">
         ...
         <button class="btn btn-xs btn-primary">Write to comments </button>
          {{comments}}&nbsp;</span>  <br> <br>
           ...
           <button class="btn btn-xs btn-primary" onClick="updateUserDob('{{lenderUser.dob}}','{{lenderUser.id}}');">Update DOB</button>
