                        ...
                        <div class="row col-md-12 hold-amount-box ">
                            <div class="row col-md-6 pull-left fdtransferPayment">
                                ...
                                <div class="row col-md-12 transferFeeAmountfromSystem" style="display:none">
                                   ...
                                   <div class="row col-md-12 fdFundTransferRemarks" style="display:none">
                                    <label for="" class="form-label col-md-4">Remarks:<em
                                            class="error">*</em>
                                    </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-fd-input col-md-12" name="" id="fdFundTransferRemarks"
                                            placeholder="Enter Fd Remarks" aria-describedby="helpId">
                                        <span class="error remarksError" style="display:none">Enter Remarks </span>
                                    </div>
                                </div>
