...
function getadviceSeekers() {
	...
	if (userisIn == "local") {
		var seekersData =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/fetchAdviseSeekers/" +
			suserId;
	} else {
		var seekersData =
...
function partnerVerifyMobile() {
	...
	if (userisIn == "local") {
		var getotp =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyingMobileAndEmailForPartner";
	} else {
		var getotp =
...
//   if (userisIn == "local") {
//     var getsession =
//     "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/"+suserId+"/accessTokenGeneration";
