...
$(document).ready(function () {
	...
	function newprofileCallDetails() {
		...
		if (userisIn == "local") {
			var newprofileapi =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/lender/personal/" +
				suserId;
		} else {
			var newprofileapi =
...
function getUserDetails() {
	...
	if (userisIn == "local") {
		var personalDetailsUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/personal/" +
			suserId +
			"";
	} else {
		var personalDetailsUrl =
...
function loadprofessionalDetails() {
	...
	if (userisIn == "local") {
		//http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/
		var getStatUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/professional/" +
			id +
			"";
	} else {
		// https://fintech.oxyloans.com/oxyloans/
...
function loadfinancialDetails() {
	...
	if (userisIn == "local") {
		//http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/
		var getStatUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getfinancialDetails/" +
			id +
			"";
	} else {
		// https://fintech.oxyloans.com/oxyloans/
...
function loadbankDetails() {
	...
	if (userisIn == "local") {
		var getStatUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/bankdetails/" +
			id +
			"";
	} else {
		var getStatUrl =
...
function signout() {
	...
	if (userisIn == "local") {
		var signoutUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/logout";
	} else {
...
function posteMandateResponse() {
	...
	if (userisIn == "local") {
		var posteMandateResponseCall =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/merchant/ICICI/response";
	} else {
		var posteMandateResponseCall =
...
$(document).ready(function () {
	...
	$("#borrowernewprofile").click(function () {
		...
		if (userisIn == "local") {
			regUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/profile/" +
				userId +
				"";
		} else {
			regUrl =
	...
	$("#pincode").on("keyup", function (e) {
		...
		if ($this.val().length == 6) {
			var pincode = $("#pincode").val();
			//var getStatUrl = "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/"+pincode+"/pincode";
			if (userisIn == "local") {
				var getStatUrl =
					"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/" +
					pincode +
	...
	$(document).ready(function () {
		$("#user-bank-verify").click(function () {
			...
			if (userisIn == "local") {
				validate =
					"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyBankAccountAndIfsc";
			} else {
				validate =
	...
	$(document).ready(function () {
		$("#studentUniversity,#studentLocation,#studentCountry").focusout(function (
			...
			if (
				...
				if (userisIn == "local") {
					var studentUrl =
						"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/student_info";
				} else {
					var studentUrl =
...
function updateTransactionStatus(
	...
	if (userisIn == "local") {
		var updateEmiUrlCard =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/loan/" +
			transactionId +
...
function favouriteThisBorrower() {
	...
	if (userisIn == "local") {
		var favouriteUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/favourite";
	} else {
		var favouriteUrl =
...
function acceptLoanOffer() {
	...
	if (userisIn == "local") {
		var updateCommentUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/loanOfferAccepetence";
	} else {
		var updateCommentUrl =
...
$(document).ready(function () {
	...
	$("#lender-nominee-btn").click(function () {
		...
		if (userisIn == "local") {
			regUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/nominee";
		} else {
...
$(document).ready(function () {
	...
	$("#btn-autoinvest").click(function () {
		...
		if (userisIn == "local") {
			autoinvestUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/saveautoinvestconfig";
		} else {
			autoinvestUrl =
	...
	$("#btn-autoinvestUpdate").click(function () {
		...
		if (userisIn == "local") {
			autoinvestUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/updateautoinvestconfig ";
		} else {
			autoinvestUrl =
	...
	$("#btn-autoinvestDeactivate").click(function () {
		...
		if (userisIn == "local") {
			autoinvestUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/inactiveautoinvestconfig";
		} else {
			autoinvestUrl =
...
function loadlendersAutoinvesthistory() {
	...
	if (userisIn == "local") {
		var getLenders =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getlenderautoinvesthistory";
	} else {
		var getLenders =
...
$(document).ready(function () {
	...
	$("#btn-withdrawal").click(function () {
		...
		if (userisIn == "local") {
			withdrawUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/savewithdrawalfundsinfo";
		} else {
			withdrawUrl =
...
function loadlenderswithdrawfundslist() {
	...
	if (userisIn == "local") {
		var getLenders =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/lenderwithdrawalfundssearch";
	} else {
		var getLenders =
...
$(document).ready(function () {
	$("#btn-Reinvest").click(function () {
		...
		if (userisIn == "local") {
			autoinvestUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/saverelendconfig";
		} else {
			autoinvestUrl =
	...
	$("#updateReinvest-btn").click(function () {
		...
		if (userisIn == "local") {
			autoinvestUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/updaterelendconfig ";
		} else {
			autoinvestUrl =
...
const durationIncr = () => {
	...
	const updateDuration =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/updatingDuration`
...
const emailcontent = async () => {
	try {
		...
		const getStatUrl =
			userisIn === "local"
				? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/mailContentShowingToLender"
...
$(document).ready(function () {
	$("#referee-submit-btn").click(function () {
		...
		if (userisIn == "local") {
			var getStatUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/lenderReferring";
		} else {
			var getStatUrl =
...
const borrowersemiamount = async () => {
	try {
		...
		const updateEmiUrlCard =
			userisIn === "local"
				? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getLoanOwners"
...
const viewborrowers = async (name) => {
	try {
		...
		const updateEmiUrlCard =
			userisIn === "local"
				? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${name}/getBorrowersLoanInfo`
...
const newdashboardcall = () => {
	...
	const newdashboardcallURL =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/lenderDashboard`
...
const getGmailAuthorization = async () => {
	try {
		...
		const getGmailAuthUrl =
			userisIn === "local"
				? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getGmailAuthorization/gmailcontacts/${sprimaryType}/OXYLOANS`
...
function Gmailcontacts() {
	...
	if (userisIn == "local") {
		var actOnLoan =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getContactsFromGmailAccount/" +
			userId;
	} else {
		var actOnLoan =
			...
			if (data.length == 0) {
				...
				$(".acceptedPagination")
					...
					.on("page", function (event, num) {
						...
						if (userisIn == "local") {
							var actOnLoan =
								"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getLenderStoredEmailContacts/" +
								suserId;
						} else {
							var actOnLoan =
...
const getlendercontacts = async () => {
	...
	const getGmailAuthorization =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getLenderStoredEmailContacts/${suserId}`
...
const viewpaymentStatus = (id) => {
	...
	const getpaymentstatus =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${id}/displayingRefereePaymentStatus`
	...
	if (userSubscriptionStatus == false) {
		...
		if (userisIn == "local") {
			var updateparticipation =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/updatingLenderDeal";
		} else {
			var updateparticipation =
...
function getgroupingofborrowers() {
	...
	if (userisIn == "local") {
		var getborrowers =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/groupingOfBorrowers";
	} else {
		var getborrowers =
...
function yesPayThrouhWallets(dealType, dealId) {
	...
	if (userisIn == "local") {
		var updateparticipation =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/lenderFeeThroughWallet";
	} else {
		var updateparticipation =
...
const viewNewLenderStatement = (dealId, dealName) => {
	...
	const getpaymentstatus =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/${dealId}/loanStatementBasedOnCurrentValue`
...
const viewDealLenders = (dealId) => {
	...
	const getDeals =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${dealId}/listOfLenders`
...
function getoxyfoundingamountInfo() {
	...
	if (userisIn == "local") {
		var getamountinfo =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/sumOfDealsAmountByLendersGroup";
	} else {
		var getamountinfo =
...
const getlendergroupname = () => {
	...
	const updateEmiUrlCard =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/listOfOxyLendersGroup"
...
function verifyWhatsappNumber() {
	...
	if (userisIn == "local") {
		var whatsAppUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/sendWhatsappOtp";
	} else {
		var whatsAppUrl =
...
const verifyWhatsappOtp = () => {
	...
	const whatsAppUrl =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyWhatsappOtp"
...
function getadviceSeekers() {
	...
	const seekersData =
		userisIn == "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/fetchAdviseSeekers/${suserId}`
...
const permissionToseekers = async () => {
	...
	const permissionToseekers =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/assignUserExpertise"
...
async function viewADDStatement(dealId) {
	...
	const getparticipationStatus =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/${dealId}/paticipationChanges`
...
const dealsStats = () => {
	...
	const getDealStats =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/dealsStatistics`
...
async function viewClosedDeals() {
	try {
		...
		const getDealsUrl =
			userisIn === "local"
				? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/closedDealsForUserBasedOnPagination"
...
function viewAssetDealInfo() {
	...
	if (userisIn == "local") {
		var getDeals =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/assert_based_closed_deals";
	} else {
		var getDeals =
...
function loadnewDBInterestsInfo(sortByType) {
	...
	if (userisIn == "local") {
		var getInterestDetails =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/newLenderDashboard";
	} else {
		var getInterestDetails =
...
const downloadExcelNewDB = async (inputType) => {
	try {
		...
		const excelUrl =
			userisIn === "local"
				? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/excelsForNewLenderDashboard"
...
const downloadReferralStatus = () => {
	...
	const referralUrl =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/referralStatusInfo`
...
const downloadReferralAmountStatement = () => {
	...
	const referralUrl =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/referralBonusAmountLink`
...
const ignoreNewbankDeatils = () => {
	...
	const ignoreURL =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/bankDetailsVerification"
...
function referralBonusAmountBasedONStatus(paymentStatus) {
	...
	if (userisIn == "local") {
		var getborrowers =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/referralBonusAmountBasedOnStatus";
	} else {
		var getborrowers =
...
const downloadreferrencePaymentStatus = (earnStatus) => {
	...
	const ignoreURL =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/downLoadLinkForBonusAmount"
...
function getViewTicketHistory(queryStatus) {
	...
	if (userisIn == "local") {
		var getborrowers =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/queryDetailsBasedOnUserId";
	} else {
		var getborrowers =
...
const subinquiries = (id) => {
	...
	const viewSubQuery =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/listOfQueriesHisory"
...
const breakupmyParticipation = (dealId) => {
	...
	const getmyparticipationBreakUP =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getLenderIndividualReturns"
...
$(document).ready(function () {
	$("#btn-withdrawDealFunds").click(function () {
		...
		if (userisIn == "local") {
			withdrawUrl =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/withdrawalFundsFromDeals";
		} else {
			withdrawUrl =
...
const viewWithdrawalBreakUp = (dealid) => {
	...
	const getWithdrawalBreakUP =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/${dealid}/displayingWithdrawalRequests`
...
$(document).ready(function () {
	$("#genQRcode").click(function () {
		...
		if (userisIn == "local") {
			QRLink =
				"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/QRTransactionInitiation";
		} else {
			QRLink =
...
const loanEligibilitybyreferring = () => {
	...
	const loaneligibility =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/borrowerEligibilityDetails`
...
function editandrejectLoanRequest(localstatus) {
	...
	const editloanRequest =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${userId}/loan/${primaryType}/updateLoanRequest`
...
const getLenderPassonEducation = () => {
	...
	const getpassion =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/displayEducationAndPassionTypes"
...
const mappedUsersFormSystem = (
	...
	const mappedUrl =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/mappedUsers`
...
function getEmiData() {
	...
	if (userisIn == "local") {
		var emiCal =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/borrowerEmiDetails";
	} else {
		var emiCal =
...
function borrowerqrpayout(loanid, emiNumber) {
	...
	if (userisIn == "local") {
		QRLink =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/getPaymentDetailsByCashFree";
	} else {
		QRLink =
...
function getVerifyPan() {
	...
	if (userisIn == "local") {
		var verifyPan =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyPan?pan=" +
			panno;
	} else {
		var verifyPan =
...
// 			if (userisIn == "local") {
// 				var verifyAadhar =
// 					"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/aadharOtpGeneration";
// 			} else {
// 				var verifyAadhar =
...
// 			if (userisIn == "local") {
// 				var verifyAadharotp =
// 					"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyAadharOtp";
// 			} else {
// 				var verifyAadharotp =
...
function lenderFeeUpdateDetails() {
	...
	if (userisIn == "local") {
		var feeDetails =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/lender_fee_amount_details";
	} else {
		var feeDetails =
...
async function downloadOverallINFO() {
	...
	if (userisIn === "local") {
		downloadExcl = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${userId}/closedDealsDownloadForUser`;
	} else {
...
async function downloadOverallRunningandclosedINFO(typeoffile = "RUNNING") {
	...
	if (userisIn === "local") {
		downloadExcl = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${userId}/${typeoffile}/excel-sheet-download`;
	} else {
		downloadExcl = `https://fintech.oxyloans.com/oxyloans/v1/user/${userId}/closedDealsDownloadForUser`;
	}
...
const applicationLevelEnach = () => {
	...
	if (userisIn === "local") {
		appLevelEnach = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${userId}/loan/${primaryType}/searchEnachMandateApplicationLevel`;
	} else {
...
const AppLevelsaveEMandateResponse = (merchantResponseString) => {
	...
	if (userisIn === "local") {
		getStatUrl = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${userId}/loan/enachForApplicationLevel/response`;
	} else {
...
const AppLevelsubmitOTPeSign = () => {
	...
	if (isOTPerrmsgs === true) {
		const esignAgree =
			userisIn === "local"
				? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/loan/${sprimaryType}/${loanIDFromEsign}/uploadEsignedAgreementPdfforDealInApplicationLevel`
...
const agreeNotifcation = (id) => {
	...
	const notification =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${id}/notificationStatusUpdation`
...
const transferfundsConfirmation = () => {
	...
	const transfer =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/principal_return_account_type"
...
const renewalUnsbscribtion = () => {
	...
	const renewalnotification =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/updatingRenewalMessageStatus"
...
const verifyRefMobileNumber = (otpuser, inputId) => {
	...
	const referenceotp =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/verifyMobileOtpValue"
...
setTimeout(() => {
	$("#user-referrence-details").click(() => {
		...
		const referrenceUrl =
			userisIn === "local"
				? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/borrowerReferenceDetails"
...
const downloadRunningDealsInfo = () => {
	...
	const refExcel =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/downloadRunningDeals`
...
const partialclosedDownloadExcel = () => {
	...
	const refExcel =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/partiallyClosedDealsDownload`
...
const w2wWithdrawal = () => {
	...
	const withdrawUrlw2w =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/wallet_amount_transfer"
...
const applicationLevelEmiInfo = () => {
	...
	const updateAppEmis =
		userisIn == "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/loan/${sprimaryType}/searchLoansInAppLevel`
...
const getAppLevelEMITABLE = () => {
	...
	const updateAppEmiUrlCard =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/loan/emicardForAppLevel`
...
const payThroughwalletFunction = () => {
	...
	const paythroughwallet =
		userisIn == "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/deducting_fee_from_wallet"
...
const payNewmembershipThroughwalletFunction = () => {
	...
	const paythroughwallet =
		userisIn == "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/deducting_lender_fee_from_wallet"
...
const getFincialData = (startdate, endDate) => {
	...
	const loadFinacialData =
		userisIn === "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/lender-income`
...
const cancelQueryRequest = () => {
	...
	const cancelUrl =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/to-cancel-ticket"
...
const cancelWithdrawRequest = () => {
	...
	const cancelwithdrawUrl =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/to-cancel-withdrawal-request"
...
function cancelMyWithdrawWalletRequest(tableId) {
	...
	if (userisIn == "local") {
		var cancelMyWithdraw =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/wallet_to_wallet_request";
	} else {
		var cancelMyWithdraw =
...
const myinterestInfoSearch = () => {
	...
	const myinterestInfoUrl =
		userisIn === "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/monthly_interest_earnings"
...
const loadStudentRunningLoans = () => {
	...
	if (userisIn == "local") {
		studentRunningLoans = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/loan/BORROWER/search`;
	} else {
...
const searchBorrowerdoc = (userType, borrowerid) => {
	...
	const apiUIrl =
		userisIn == "local"
			? "http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/6/loan/ADMIN/request/search"
...
const getFinicalYearReport = async () => {
	...
	if (userisIn === "local") {
		userFinancial = `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/financial_year_data`;
	} else {
...
const holdAmountViewToLender = async () => {
	...
	let holdAmountUrl =
		userisIn == "local"
			? `http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/${suserId}/hold-amount-details `
...
function earningUnpaidBreakup(refereeId, dealId) {
	...
	if (userisIn == "local") {
		var unpaidUrl =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/referee-deals";
	} else {
		var unpaidUrl =
...
const monthNames = ["January", "February", "March", "April", "May", "June",
  "July", "August", "September", "October", "November", "December"
	...
	if (userisIn == "local") {
		var getborrowers =
			"http://ec2-15-207-239-145.ap-south-1.compute.amazonaws.com:8080/oxyloans/v1/user/displayMonthlyReferrersAmount";
	} else {
		var getborrowers =
